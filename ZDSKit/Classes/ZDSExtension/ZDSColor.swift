...
extension UIColor {
    ...
    /// - Returns: 颜色对象
    public class func RGB(LRGB: (R: Int, G: Int, B: Int), LA: CGFloat = 1.0, DRGB: (R: Int, G: Int, B: Int), DA: CGFloat = 1.0) -> UIColor {
    ...
    /// - Returns: 颜色对象
    public class func RGB(R: (min: Int, max: Int) = (0, 255), G: (min: Int, max: Int) = (0, 255), B: (min: Int, max: Int) = (0, 255), A: (min: Int, max: Int) = (0, 100)) -> UIColor {
    ...
    /// - Returns: 颜色对象
    public class func HEX(LH: String, LA: CGFloat = 1.0, DH: String, DA: CGFloat = 1.0) -> UIColor {
        if #available(iOS 13.0, *) {
            return UIColor { traitCollection in
                switch traitCollection.userInterfaceStyle {
                case .dark:
